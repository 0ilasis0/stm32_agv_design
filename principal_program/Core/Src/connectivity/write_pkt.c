...
FnState pkt_left_speed(ByteTrcvBuf* trcv_buf)
{
    ...
    FNS_ERROR_CHECK_CLEAN(vec_byte_push_byte(&vec_byte, 0x01), vec_byte_free(&vec_byte));
    FNS_ERROR_CHECK_CLEAN(vec_byte_push_byte(&vec_byte, 0x00), vec_byte_free(&vec_byte));
