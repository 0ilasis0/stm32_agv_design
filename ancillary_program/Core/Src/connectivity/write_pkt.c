...
{
    vec_rm_all(vec_byte);
    ERROR_CHECK_FNS_RETURN(vec_byte_push(vec_byte, (uint8_t[]){CMD_B0_DATA, CMD_B1_ARM_BOTTOM, 0x01, 0x00}, 4));
...
{
    vec_rm_all(vec_byte);
    ERROR_CHECK_FNS_RETURN(vec_byte_push(vec_byte, (uint8_t[]){CMD_B0_DATA, CMD_B1_ARM_SHOULDER, 0x01, 0x00}, 4));
...
{
    vec_rm_all(vec_byte);
    ERROR_CHECK_FNS_RETURN(vec_byte_push(vec_byte, (uint8_t[]){CMD_B0_DATA, CMD_B1_ARM_ELBOW_BTM, 0x01, 0x00}, 4));
...
{
    vec_rm_all(vec_byte);
    ERROR_CHECK_FNS_RETURN(vec_byte_push(vec_byte, (uint8_t[]){CMD_B0_DATA, CMD_B1_ARM_ELBOW_TOP, 0x01, 0x00}, 4));
...
{
    vec_rm_all(vec_byte);
    ERROR_CHECK_FNS_RETURN(vec_byte_push(vec_byte, (uint8_t[]){CMD_B0_DATA, CMD_B1_ARM_WRIST, 0x01, 0x00}, 4));
...
{
    vec_rm_all(vec_byte);
    ERROR_CHECK_FNS_RETURN(vec_byte_push(vec_byte, (uint8_t[]){CMD_B0_DATA, CMD_B1_ARM_FINGER, 0x01, 0x00}, 4));
