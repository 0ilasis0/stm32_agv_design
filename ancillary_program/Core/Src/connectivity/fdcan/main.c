                    ...
                    switch (code)
                    {
                        ...
                        case CMD_WHEEL_B2_MOTION:
                        {
                            ...
                            switch (code)
                            {
                                ...
                                {
                                    vehicle_set_mode(VEHICLE_MODE_FREE);
                                    vehicle_set_direct(VEHICLE_MOTION_UNKNOWN);
            ...
            switch (code)
            {
                ...
                case CMD_VEHI_B1_MOTION:
                {
                    ...
                    switch (code)
                    {
                        ...
                        {
                            vehicle_set_mode(VEHICLE_MODE_FREE);
                            vehicle_set_direct(VEHICLE_MOTION_STOP);
                            return FNS_OK;
                        }
                        case CMD_VEHI_B2_END:
                        {
                            vehicle_set_mode(VEHICLE_MODE_FREE);
                            vehicle_set_direct(VEHICLE_MOTION_FORWARD);
                            return FNS_OK;
                        }
                        case CMD_VEHI_B2_F_TRACK:
                        {
                            vehicle_set_mode(VEHICLE_MODE_FREE);
                            vehicle_set_direct(VEHICLE_MOTION_BACKWARD);
                            return FNS_OK;
                        }
                        case CMD_VEHI_B2_TRACK:
                        {
                            vehicle_set_mode(VEHICLE_MODE_FREE);
                            vehicle_set_direct(VEHICLE_MOTION_C_CLOCKWISE);
                            return FNS_OK;
                        }
                        case CMD_VEHI_B2_SEARCH:
                        {
                            vehicle_set_mode(VEHICLE_MODE_FREE);
                            vehicle_set_direct(VEHICLE_MOTION_CLOCKWISE);
                            return FNS_OK;
                        }
                        default: break;
                    }
