...
static size_t hash_int(uint32_t key, size_t capacity) {
...
static UNUSED_FNC bool hashmap_resize(HashMap* g_map, size_t new_capacity) {
...
Result HashMap_contains(HashMap* g_map, uint32_t key) {   //不用CHECK_RESULT，我只在乎有沒有
